...
const Footer = () => {
  return (
    <footer className="mt-16 py-16 md:py-24 bg-brevana-800 text-brevana-50">
      <div className="container mx-auto px-8 md:px-16 lg:px-24">
        <div className="grid md:grid-cols-2 gap-12 md:gap-16">
          {/* Brand */}
          <div>
            <h3 className="font-logo text-3xl md:text-4xl font-semibold mb-4">
              BREVANA
            </h3>
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div>
                <Button variant="secondary" className="uppercase px-6 py-2">
                  Reservar
                </Button>
              </div>
            </div>
